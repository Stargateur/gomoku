...
public:
    ...
    void    list_param_player_game(iprotocol::ITCP_protocol<Client> &itcp_protocol, std::list<typename iprotocol::ITCP_protocol<Client>::Game_player_param *> *params);
    void    list_param_game(iprotocol::ITCP_protocol<Client> &itcp_protocol, std::list<typename iprotocol::ITCP_protocol<Client>::Game_param *> *params);
    void	game_created(iprotocol::ITCP_protocol<Client> &itcp_protocol, typename iprotocol::ITCP_protocol<Client>::Game *game);
    ...
    void    game_player_param_changed(iprotocol::ITCP_protocol<Client> &itcp_protocol, typename iprotocol::ITCP_protocol<Client>::Game_player_param *param);
    void	game_param_changed(iprotocol::ITCP_protocol<Client> &itcp_protocol, typename iprotocol::ITCP_protocol<Client>::Game_param *param);
    void	game_stone_put(iprotocol::ITCP_protocol<Client> &itcp_protocol, typename iprotocol::ITCP_protocol<Client>::Game_stone *stone);
    void	game_deleted(iprotocol::ITCP_protocol<Client> &itcp_protocol, typename iprotocol::ITCP_protocol<Client>::Game *game);
    ...
    void	message(iprotocol::ITCP_protocol<Client> &itcp_protocol, typename iprotocol::ITCP_protocol<Client>::Message *message);
private:

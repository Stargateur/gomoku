...
public:
    ...
    void	create_game(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, typename iprotocol::Game *game);
    void	join_game(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, typename iprotocol::Game *game);
    void	leave_game(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol);
    void	put_stone_game(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, typename iprotocol::Game_stone *stone);
    void    change_param_player_game(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, typename iprotocol::Game_player_param *param);
    void    change_param_game(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, typename iprotocol::Game_param *param);
    void    list_param_player_game(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, std::list<typename iprotocol::Game_player_param *> *params);
    void    list_param_game(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, std::list<typename iprotocol::Game_param *> *params);
    void	game_created(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, typename iprotocol::Game *game);
    ...
    void    game_player_param_changed(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, typename iprotocol::Game_player_param *param);
    void    game_param_changed(iprotocol::ITCP_protocol<ITCP_client> &itcp_protocol, typename iprotocol::Game_param *param);
